ask_info_function = student_first_name = input("Enter student first name")
...
if correct_info=="n": ask_info_function
if correct_info == "y": add_more_students = input("would you like to add more students?")
if add_more_students == "y": ask_info_function()
if add_more_students=="n": exit()
